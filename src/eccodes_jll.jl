...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import eccodes_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("b04048ba-5ccd-5610-b3f6-85129a548705"))
platforms = [Pkg.Artifacts.unpack_platform(e, "eccodes", artifacts_toml) for e in artifacts["eccodes"]]
...
if best_platform === nothing
    @debug("Unable to load eccodes; unsupported platform $(triplet(platform_key_abi()))")
else
